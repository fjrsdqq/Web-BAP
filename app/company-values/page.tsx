...
export default function CompanyValuesPage() {
  ...
  {t(
    ...
    'Di PT BATAVIA ASIA PROJECT, kami percaya bahwa sebuah bangunan hanya akan hidup jika didukung oleh sistem internal yang andal. Fokus utama kami adalah menghadirkan solusi MEP (Mechanical, Electrical, & Plumbing), HVAC, & Civil yang cerdas dan efisien sebagai urat nadi dari setiap infrastruktur.'
  )}
</p>
<p className="text-gray-600 leading-relaxed text-base mt-4">
            {t(
              '',
              'Sebagai mitra terpercaya, kami juga menyediakan layanan komprehensif dalam perawatan & perbaikan (maintenance), konstruksi, serta desain interior dan eksterior untuk memastikan setiap proyek berfungsi maksimal, estetis, dan tahan lama. Setiap langkah kami dipandu oleh filosofi B.U.I.L.D. '
            )}
          <p className="text-gray-600 leading-relaxed text-base mt-4">
            {t(
